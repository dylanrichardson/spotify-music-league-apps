...
export const ROUNDS: RoundConfig[] = [
  {
    ...
    path: '/spotify-music-league-apps/round-1',
    enabled: true,
  ...
  },
  {
    ...
    path: '/spotify-music-league-apps/round-2',
    enabled: true,
  ...
  },
  {
    ...
    subtitle: null,
    path: '/spotify-music-league-apps/round-3',
    enabled: false,
  ...
  },
  {
    ...
    subtitle: null,
    path: '/spotify-music-league-apps/round-4',
    enabled: false,
  ...
  },
  {
    ...
    subtitle: null,
    path: '/spotify-music-league-apps/round-5',
    enabled: true,
