...
// Use production URL for GitHub Pages, localhost for dev
const REDIRECT_URI = window.location.hostname === '127.0.0.1' || window.location.hostname === 'localhost'
  ? 'http://127.0.0.1:8080/spotify-music-league-apps/parents-birth-year'
  : `${window.location.origin}/spotify-music-league-apps/parents-birth-year`;
const SCOPES = [
  'user-library-read',
